...
const categoriesWithIcon = [
  ...
  { id: "women", label: "Women", icon: HeartIcon },
    ...
    <div className="flex flex-col min-h-screen">
      <div className="relative w-full h-[600px] overflow-hidden">
        ...
        <Button
          ...
          className="rounded-full absolute top-1/2 left-4 transform -translate-y-1 bg-white/80"
        >
        ...
        <Button
          ...
          className="rounded-full absolute top-1/2 right-4 transform -translate-y-1 bg-white/80"
        >
